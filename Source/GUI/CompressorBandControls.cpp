...

{
    ...
    bypassButton.setColour(juce::TextButton::ColourIds::buttonOnColourId, juce::Colours::slategrey);
    bypassButton.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);

    soloButton.setName("S");
    soloButton.setColour(juce::TextButton::ColourIds::buttonOnColourId, juce::Colours::lightskyblue);
    soloButton.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);

    muteButton.setName("M");
    muteButton.setColour(juce::TextButton::ColourIds::buttonOnColourId, juce::Colours::palevioletred);
    muteButton.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);
    ...
    lowBand.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);

    midBand.setName("Mid");
    midBand.setColour(juce::TextButton::ColourIds::buttonOnColourId, juce::Colours::black);
    midBand.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);

    highBand.setName("High");
    highBand.setColour(juce::TextButton::ColourIds::buttonOnColourId, juce::Colours::black);
    highBand.setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);
...
void CompressorBandControls::resetActiveBandColors()
{
    ...
    activeBand->setColour(juce::TextButton::ColourIds::buttonColourId, juce::Colours::white);
}
